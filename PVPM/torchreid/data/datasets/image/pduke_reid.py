...
class P_Dukereid(ImageDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.load_pose:
            ...
            pose_pic_name=(img_name)+'.jpg'
            if 'whole_body' in img_path:
                pose_pic_path = os.path.join(self.pose_dir,'whole_body_images',head_folder, pose_pic_name)
            else:
                pose_pic_path = os.path.join(self.pose_dir,'occluded_body_images',head_folder, pose_pic_name)

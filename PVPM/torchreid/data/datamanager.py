...
from torchreid.data.transforms import build_transforms, build_unified_transforms
...
class ImageDataManager(DataManager):
    ...
    def __init__(self, root='', sources=None, targets=None, height=256, width=128, transforms='random_flip',
                 ...
                 cuhk03_labeled=False, cuhk03_classic_split=False, market1501_500k=False, load_pose=False):
        
        super(ImageDataManager, self).__init__(sources=sources, targets=targets, height=height, width=width,
                                               transforms=transforms, use_cpu=use_cpu, load_pose=load_pose)
